...
namespace SwmsApi.Users
{
	...
	public class PasswordHasher : IPasswordHasher
	{
		...
		/// <param name="clearText">the clear text</param>
		/// <returns>the Hash</returns>
		public string CreateStringHash(string clearText)
		{
			return HashToString(clearText, DefaultIterations);
		}
		...
		/// <param name="iterations">the number of iteration the hash alogrythm should run</param>
		/// <returns>the Hash</returns>
		public string HashToString(string clearText, int iterations)
		{
